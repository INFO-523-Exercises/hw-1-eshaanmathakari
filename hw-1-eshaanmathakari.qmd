...
#Eshaan Prasad Mathakari (eshaanmathakari)
...
#searching on the R platform for 'Neural Networks'
...
#to get and set working directory

```{r}
getwd()

setwd("/cloud/project") # setwd using what you get from getwd()
```
...
#assigning a variable value and performing arithmetic functions on it
...
#generating a random number using set.seed and functions regarding same
...
#creating and performing arithmetic operations on Matrices
...
#creating and classifying classes
